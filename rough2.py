...
RED = (255, 0, 0)
BLACK = (0, 0, 0)
SKYBLUE = pygame.Color('lightskyblue3')
...
def display_text(text, color, x, y):
    screen_text = text_font.render(text, 1, color)
...
def get_sentence(): #SCRAPER
    url = f"https://sentence.yourdictionary.com/linux"
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if (x>20 and y>532 and x<150 and y<582):
                    main_window()
            if event.type == pygame.KEYDOWN:#checka if any button was pressed
